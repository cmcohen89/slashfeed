            ...
            <div className='featured-posts'>
                ...
                <div className='main-post'>
                    <NavLink to={`/posts/${allPosts[1].id}`}>
                        ...
                        <img className='featured-img' src={allPosts[1].postImages[allPosts[1].previewImgId].url} alt="" />
                    </NavLink>
                </div>
                <div className='main-post'>
                    <NavLink to={`/posts/${allPosts[2].id}`}>
                        ...
                        <img className='featured-img' src={allPosts[2].postImages[allPosts[2].previewImgId].url} alt="" />
                    </NavLink>
                </div>
            </div>
            <div className='more'>
